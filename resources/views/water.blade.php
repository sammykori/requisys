    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Water</h1>
          <p class="mb-4">Fill a form for the amount of water you want to request and continue to track till your request have been approved <a target="_blank" href="https://datatables.net">official DataTables documentation</a>.</p>
            ...
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title">Water Requisition Form</h5>
                ...
                <div class="modal-body">
                  ...
                  <form>
                    <div class="form-group row">
                      <div class="col-sm-2">
                        <input type="number" class="form-control" id="numberWater" placeholder="Number">
                      </div>
                    </div>
                    <br>
                    <hr>
