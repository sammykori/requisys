  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="./dashboard">
        ...
        <div class="sidebar-brand-text mx-3">RequiSys</div>
      </a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">Fill a form for the type of File you want to request and continue to track till your request have been approved <a target="_blank" href="https://datatables.net">official DataTables documentation</a>.</p>
                ...
                <div class="modal-body"> --}}
                  ...
                  {!! Form::open(['action' => 'RecordsController@store', 'method'=> 'POST']) !!}
                    <div class="form-group row">
                      <div class="col-sm-10">
                        {{Form::text('file', '', ['class' => 'form-control dropdown-toggle', 'id' => 'searchFile', 'placeholder' => 'Search for file', 'data-toggle' => 'dropdown', 'aria-haspopup' => 'true', 'aria-expanded' => 'false'])}}
                    ...
                    <div class="form-group row">
                        <div class="col-sm-10">
                          {{Form::select('superior', ['1' => 'Kofi Datsa', '2' => 'Golda Adjei', '3' => 'Isaac Boateng'], null, ['placeholder' => 'Select Division Head to approve', 'class' => 'custom-select form-control'])}}
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; NSPs 2019</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
