    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">Fill a form to request for a vehicle and continue to track till your request have been approved <a target="_blank" href="https://datatables.net">official DataTables documentation</a>.</p>
            ...
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title">Vehicle Requisition Form</h5>
                    ...
                    <div class="form-group row">
                      <div class="col-sm-6">
                        <div class="dates">
                            ...
                            <input data-format="yyyy-MM-dd" id="date1" type="text" autocomplete="off" class="form-control" placeholder="yyyy-mm-dd"/>
                            <span class="add-on">
                      ...
                      <div class="col-sm-6">
                        <div class="dates">
                            ...
                            <input data-format="yyyy-MM-dd" id="date2" type="text" autocomplete="off" class="form-control" placeholder="yyyy-mm-dd"/>
                            <span class="add-on">
                              <i data-time-icon="icon-time" data-date-icon="icon-calendar">
                              </i>
                            </span>
